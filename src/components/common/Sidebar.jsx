function Sidebar() {
    return (
        <>
            {/* Sidebar */}
            <div className="hidden h-screen md:flex flex-col w-64 bg-[#9CBBFF] ">
                <div className="flex flex-col flex-1 overflow-y-auto">
                    <nav className="flex flex-col flex-1 overflow-y-auto bg-[#9CBBFF]px-2 py-4 gap-10 rounded-2xl">

                        <div>
                            <a href="#" className="flex items-center px-4 py-2 text-gray-100 hover:bg-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                        d="M4 6h16M4 12h16M4 18h16" />
                                </svg>
                                <span className="text-lg font-semibold ">VoyageLib</span>
                            </a>
                        </div>
                        ...
                        <div className="flex flex-col flex-1 gap-3">
                            ...
                            <a href="/book/create" className="flex items-center px-4 py-2 mt-2 text-white hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    className="mr-2" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h7v-2H5V5h14v5h2V5c0-1.1-.9-2-2-2m-3 7h-4v4h-2v-4H6V8h4V4h2v4h4v2z" />
                                </svg>
                                Create Book
                            </a>
                            ...
                            {/* Users */}
                            <a href="#" className="flex items-center px-4 py-2 mt-auto text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    className="mr-2" viewBox="0 0 32 32">
                                    <path fill="currentColor"
